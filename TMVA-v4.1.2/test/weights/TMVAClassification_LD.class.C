...
InvarMass                     InvarMass                     InvarMass                     InvarMass                                                       'F'    [19.6578006744,3072]
MR                            MR                            MR                            MR                                                              'F'    [65.1877975464,3100.58007812]
...
class ReadLD : public IClassifierReader {
 ...
 public:
   ...
   {      
      ...
      fVmin[2] = 19.6578006744385;
      fVmax[2] = 3072;
      fVmin[3] = 65.1877975463867;
...
{
   fLDCoefficients.push_back( -0.136738577783 );
   fLDCoefficients.push_back( 0.000249474104747 );
   fLDCoefficients.push_back( -0.0491936179276 );
   fLDCoefficients.push_back( -0.000141074424305 );
   fLDCoefficients.push_back( 0.000604795746557 );
   fLDCoefficients.push_back( -0.00226815902028 );
