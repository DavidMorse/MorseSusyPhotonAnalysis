...
void AcceptanceSMS_TchiZH_ZincHgg_2J(){

  TFile finZH("/data/ndpc3/b/dmorse/RA3/AnalysisOutput/hist_HiggsAna_Photon_SMS_TChiZH_ZincHgg_2J.root");
  //TFile finZH("/data/ndpc3/b/dmorse/RA3/AnalysisOutput/hist_HiggsAna_Photon_SMS_TChiZH_ZincHgg_2J_3otherTriggers.root");
  TFile fLimitsSigSMS_ZH("signal_contamination_SMS_TChiZH_ZincHgg_2J.root","RECREATE");
  //TFile fLimitsSigSMS_ZH("signal_contamination_aaz.root","RECREATE");
  //TFile fLimitsSigSMS_ZH("signal_contamination_aaWW.root","RECREATE");
  ...
  */
  ...
  x_secsAAW[275]=0.162;
  x_secsAAW[300]=0.111;
  x_secsAAW[325]=0.0779;
  x_secsAAW[350]=0.0553;
  x_secsAAW[375]=0.0401;
  x_secsAAW[400]=0.0294;
  x_secsAAW[425]=0.0218;
  x_secsAAW[450]=0.0163;
  x_secsAAW[475]=0.0123;
  x_secsAAW[500]=0.0094;
  ...
  TH3F* ggWe  = (TH3F*)finZH.Get("gg_SMS_Loose_1Ele_0_1Jets_mChi_mBino_met");
  TH3F* ggWmu = (TH3F*)finZH.Get("gg_SMS_Loose_1Mu_0_1Jets_mChi_mBino_met");
  TH2F* h_nEvents = (TH2F*)finZH.Get("SMS_mChi_mBino"); 	
  ...
  PrelimText->AddText("CMS Preliminary                  SMS Z(#rightarrowInclusive)H(#gamma#gamma)+2Jet");
  ...
  for(int i=1;i<=ggWe->GetNbinsX();i++){
    for(int j=1;j<=ggWe->GetNbinsY();j++){
      ...
      fLimitsSigSMS_ZH.cd();
      ggWe->Write("h_ggWe_met_mChi"+MCHI+"_mBino"+MBINO);
      ...
      //cout<<mS<<endl<<mG<<endl<<val<<endl;
      fLimitsSigSMS_ZH.cd();
      ggWmu->Write("h_ggWmu_met_mChi"+MCHI+"_mBino"+MBINO);
  ...
  */
  ...
  PrelimText2->AddText("CMS Preliminary                  SMS Z(#rightarrowInclusive)H(#gamma#gamma)+2Jet");
  ...
  WeText->Draw();
  c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_We.png");
  c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_We.pdf");
  /*
  c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_We_3otherTrigs.png");
  c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_We_3otherTrigs.pdf");
  */
  ...
  WmuText->Draw();
  c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_Wmu.png");
  c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_Wmu.pdf");
  /*
  //c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_Wmu_3otherTrigs.png");
  //c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_Wmu_3otherTrigs.pdf");
  ...
  c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_Znunu.png");
  c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_Znunu.pdf");
  
  //c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_Znunu_3otherTrigs.png");
  //c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_Znunu_3otherTrigs.pdf");
  ...
  c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_WWlnulnu.png");
  c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_WWlnulnu.pdf");
  
  //c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_WWlnulnu_3otherTrigs.png");
  //c1->Print("Plots/Higgs/AcceptanceTimesEfficiency_SMS_TChiZH_ZincHgg_2J_WWlnulnu_3otherTrigs.pdf");
  */
  int j=0,k=0;
