...
void ffgfcomb(){
  ...
  TH1F* gg = (TH1F*)f_nojet.Get("met_gg_nojet");gg->Sumw2();
  TH1F* ff = (TH1F*)f_nojet.Get("met_ff_nojet");ff->Sumw2();
  TH1F* gf = (TH1F*)f_nojet.Get("met_gammafake_nojet");gf->Sumw2();
  ...
  //TH1F* gg_jet = (TH1F*)f_1jet.Get("ggMet_JetReq");gg_jet->Sumw2();
  //TH1F* ff_jet = (TH1F*)f_1jet.Get("ffMet_reweightJet_binned_JetReq");ff_jet->Sumw2();
  //TH1F* gf_jet = (TH1F*)f_1jet.Get("gammafakeMet_reweightJet_binned_JetReq");gf_jet->Sumw2();
  //TH1F* fg_jet = (TH1F*)f_1jet.Get("fgMet_reweightJet_binned_JetReq");fg_jet->Sumw2();
  
  TH1F* gg_jet = (TH1F*)f_1jet.Get("met_gg_1jet");gg_jet->Sumw2();
  TH1F* ff_jet = (TH1F*)f_1jet.Get("met_ff_1jet");ff_jet->Sumw2();
  TH1F* gf_jet = (TH1F*)f_1jet.Get("met_gammafake_1jet");gf_jet->Sumw2();
